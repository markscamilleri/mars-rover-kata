...
describe("Mars Rover", () => {
  describe.each([
    {
      startingPosition: { x: 0, y: 0, direction: Direction.NORTH },
      left: Direction.WEST,
      right: Direction.EAST,
      movedPosition: { x: 0, y: 1, direction: Direction.NORTH },
    },
    {
      startingPosition: { x: 4, y: 0, direction: Direction.WEST },
      left: Direction.SOUTH,
      right: Direction.NORTH,
      movedPosition: { x: 3, y: 0, direction: Direction.WEST },
    },
    {
      startingPosition: { x: 0, y: 4, direction: Direction.SOUTH },
      left: Direction.EAST,
      right: Direction.WEST,
      movedPosition: { x: 0, y: 3, direction: Direction.SOUTH },
    },
    {
      startingPosition: { x: 0, y: 0, direction: Direction.EAST },
      left: Direction.NORTH,
      right: Direction.SOUTH,
      movedPosition: { x: 1, y: 0, direction: Direction.EAST },
    },
  ])(
    "When the Mars Rover is instantiated at the co-ordinates $startingPosition",
    ({ startingPosition, left, right, movedPosition }) => {
      let rover: MarsRover;
      ...
      describe("And it is given the command to undo", () => {
        beforeEach(() => {
          rover.turnLeft();
          rover.turnRight();
          rover.turnLeft();
